...
<div id="content">
		...
		<tr>
			...
			<td align = "center"><img src = "bunny.jpg" />
				<br /><input type = "button" id = "bunny" 
				value = "Bunny Details" onclick = "getMore('bunny')" /></td>
			<td align = "center"><img src = "princess.jpg" />
				<br /><input type = "button" id = "princess" 
				value = "Princess Details" onclick = "getMore('princess')" /></td>
			<td align = "center"><img src = "ghost.jpg" />
				<br /><input type = "button" id = "ghost" 
				value = "Ghost Details" onclick = "getMore('ghost')" /></td>
			<td align = "center"><img src = "wizard.jpg" />
				<br /><input type = "button" id = "wizard" 
				value = "Wizard Details" onclick = "getMore('wizard')" /></td>
			<td align = "center"><img src = "elf.jpg" />
				<br /><input type = "button" id = "elf" 
				value = "Elf Details" onclick = "getMore('elf')" /></td>
		</tr>
		<tr>
